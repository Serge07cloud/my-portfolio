  ...
  return (
    <>
      <div className="text-center mx-auto max-w-5xl pb-48 sm:pb-48 lg:pb-48">
        <h1 className="text-5xl font-bold tracking-tight text-balance dark:text-white sm:text-7xl">Ready to build <span className="bg-clip-text text-transparent bg-linear-to-r from-indigo-500 via-purple-500 to-blue-500">something Amazing</span>
        </h1>
