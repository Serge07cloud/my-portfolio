    ...
    <>
      <div>
        ...
        <div className="text-center mx-auto max-w-5xl pb-24 sm:pb-24 lg:pb-24">
          <h1 className="text-5xl font-bold tracking-tight text-balance dark:text-white sm:text-5xl">Why hire <span className="font-bold bg-clip-text text-transparent bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500">Me?</span></h1>
          ...
          <div className="grid place-content-center lg:grid-cols-3 lg:gap-3 mt-14">
            ...
            <a href="#" className="max-w-sm p-6 mb-7 bg-white border border-gray-200 rounded-lg shadow-sm  dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-800 flex flex-column">
