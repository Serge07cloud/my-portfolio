    ...
    <>
      <div>
        <div className="mx-auto max-w-2xl py-32 sm:py-32 lg:py-32">
          ...
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative flex justify-center items-center rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-black/10 hover:ring-white/20">
              ...
              <div>
                Open to collaborative research and development. <a href="#" className="font-semibold text-indigo-400"><span aria-hidden="true" className="absolute inset-0"></span>Get in touch <span aria-hidden="true">&rarr;</span></a>
              </div>
            </div>
          </div>
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance dark:text-white sm:text-7xl">I can help you turn your ideas in seamless digital experiences</h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Hi, Welcome on my digital portfolio. I am <span className="text-xl  dark:text-gray-50">Landry Konan</span>, a fullstack web developer building smart, fun and scalable web applications.</p>
            <CoreTech />
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a href="#" className="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 animate-pulse">Get in touch</a>
              <a href="#" className="text-sm/6 font-semibold dark:text-white">See projects <span aria-hidden="true">→</span></a>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mx-auto max-w-5xl pb-24 sm:pb-24 lg:pb-24">
          <h1 className="text-5xl font-bold tracking-tight text-balance dark:text-white sm:text-5xl">Why hire <span className="font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">Me?</span></h1>
          <h1 className="py-3.5 text-3xl font-bold tracking-tight text-balance text-gray-400 dark:text-white sm:text-4xl">A Foundation of Trust and Excellence</h1>
          ...
          <div className="grid place-content-center lg:grid-cols-3 lg:gap-3 mt-14">
            ...
            <a href="#" className="max-w-sm p-6 mb-7 bg-white bg-gray-900 border border-gray-200 rounded-lg shadow-sm  dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-800 flex flex-column">
              ...
              <div className="text-left">
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">
                  More than 15 personal and client projects architected and delivered over the past 5 years.
                </p>
              </div>
            ...
            <a href="#" className="max-w-sm p-6 mb-7 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-800 flex flex-column">
              ...
              <div className="text-left">
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">Proven track record of collaborating with and delivering solutions that meet clients goals.</p>
              </div>
            ...
            <a href="#" className=" max-w-sm p-6 mb-7 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-800 flex flex-column">
              ...
              <div className="text-left">
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">
                  Graduate of the School of Mathematics and Computer Science at FHB University.
                </p>
              </div>
